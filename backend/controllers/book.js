const Book = require('../models/Book');   // Pour interagir avec la base de données des livres
const fs = require('fs');   //  Pour travailler avec les fichiers, notamment pour la suppression d'images de livres

exports.getAllBooks = (req, res, next) => {
  Book.find()    // Méthode de Mongoose
...
exports.createBook = (req, res, next) => {
  const bookObject = JSON.parse(req.body.book);   // Convertit la chaine JSON de la requête en un objet JS utilisable 
